...
class Drawable(object):
    ...
    def draw(self, drawSurface):
      drawImage = pygame.transform.flip(self.image, self.flipped, False) if self.flipped else self.image
      drawSurface.blit(drawImage, list(map(int, self.position - Drawable.CAMERA_OFFSET)))
